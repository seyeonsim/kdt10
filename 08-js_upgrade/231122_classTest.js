...
// 집 이라는 클래스
/*
속성 : 만들어진 연도, 집의 이름, 창문 개수 등
메소드 : 창문 개수 출력하는 메소드, 집의 이름 출력하는 메소드 등
*/

// 클래스 정의
class House {
    // 생성자 함수
    // : 클래스를 이용해 객체를 생성할 때마다 속성을 초기화 해 줌
    ...
    // 메소드 2 :  창문 개수 출력
    getWindow() {
        console.log(`${this.name}의 창문 개수는 ${this.window}개다!`)
    }
}
...
class Apartment extends House {
    constructor(year, name, window, floor){
        // super(); 부모 객체에서 상속 받음 : 상속 받은 부모 클래스의 생성자를 호출
